...
class Tensor(object):
  ...
  def __add__(lhs, rhs):
    return call_singa_func(singa.Add_TT, lhs.singa_tensor, rhs.singa_tensor)

  def __sub__(lhs, rhs):
    return call_singa_func(singa.Sub_TT, lhs.singa_tensor, rhs.singa_tensor)

  def __mul__(lhs, rhs):
    return call_singa_func(singa.Mul_TT, lhs.singa_tensor, rhs.singa_tensor)

  def __div__(lhs, rhs):
    return call_singa_func(singa.Div_TT, lhs.singa_tensor, rhs.singa_tensor)
...
def call_singa_func(_singa_func, *args):
  new_t = Tensor()
...
def abs(t):
  return call_singa_func(singa.Abs, t.singa_tensor)

def exp(t):
  return call_singa_func(singa.Exp, t.singa_tensor)

def log(t):
  return call_singa_func(singa.Log, t.singa_tensor)

def relu(t):
  return call_singa_func(singa.ReLU, t.singa_tensor)

def sigmoid(t):
  return call_singa_func(singa.Sigmoid, t.singa_tensor)

def square(t):
  return call_singa_func(singa.Square, t.singa_tensor)

def tanh(t):
  return call_singa_func(singa.Tanh, t.singa_tensor)

def sum(t, axis=None):
  if axis == None:
    return singa.floatSum(t.singa_tensor)
  else:
    return call_singa_func(singa.Sum, t.singa_tensor, axis)

def average(t, axis=0):
  return call_singa_func(singa.Average, t.singa_tensor, axis)

def softmax(t, axis=0):
  return call_singa_func(singa.SoftMax, t.singa_tensor, axis)
...
def lessthan(t, x):
  return singa.floatLT_op(t.singa_tensor, x)
...
t1 += 1.2345
print 't1 += 1.234, i.e., t1.__iadd__(1.2345): \n', t1.data()
print
