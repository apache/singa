...
void SwapGPU::swap_plan(){
  ...
  double overhead = 0;
  swap_sched(vec_swap_pri, vec_load_pri,overhead,350<<20, mode);
  cout<<"load 2 overhead pri: "<<overhead<<endl;
  overhead = 0;
  swap_sched(vec_swap_dto, vec_load_dto,overhead,350<<20,mode);
  cout<<"load 2 overhead dto: "<<overhead<<endl;
  overhead = 0;
  swap_sched(vec_swap_wdto, vec_load_wdto,overhead,350<<20,mode);
