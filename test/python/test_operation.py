...
class TestPythonOperation(unittest.TestCase):
    ...
    def test_Equal_gpu(self):
        ...
        dx0,dx1 = result.creator.backward(x0.data)

        np.testing.assert_array_almost_equal(tensor.to_numpy(result), y, decimal=5)
        np.testing.assert_array_almost_equal(tensor.to_numpy(tensor.from_raw_tensor(dx0)), [[0.,1.],[0.,1.],[0.,1.]], decimal=5)
        np.testing.assert_array_almost_equal(tensor.to_numpy(tensor.from_raw_tensor(dx1)), [[0.,1.],[0.,1.],[0.,1.]], decimal=5)
