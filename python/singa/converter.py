...
class caffeConverter:
    ...
    def __init__(self, net_proto, solver_proto, input_sample_shape):
    ...
    def convert_engine(self, layer_conf, caffe_solver):
        '''
        ...
        '''
        caffe_engine = ''
        solver_mode = caffe_solver.solver_mode
        singa_engine = ''
